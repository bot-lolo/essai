...
class EtudiantController extends AbstractController
{
    ...
    #[Route('/search/{etudiant}', name: 'search_etudiant')]
    public function search(Request $request,Etudiant $etudiant,EtudiantRepository $etudiantRepository): Response
    {
        $etudiant=new Etudiant();
        ...
        if($form->isSubmitted()&& $form->isValid()){
            $nom=$_GET['nom'];
            //$etudiantRepository->edit($nom,true);
            return $this->renderForm('etudiant/aff.html.twig',[
                'etudiants'=>$etudiantRepository->edit($nom,true),
                //'conter'=>$etudiantRepository->cont(),
            ]);
        }
