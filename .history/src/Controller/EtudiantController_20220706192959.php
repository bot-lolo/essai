...
class EtudiantController extends AbstractController
{
    ...
    public function new(Request $request,EtudiantRepository $doctrine, ClasseRepository $clas): Response
    {
    ...
    public function edit(Request $request,EtudiantRepository $etudiantRepository,Etudiant $etudiant, ClasseRepository $classeRepository): Response
    {
