...
class EtudiantController extends AbstractController
{
    ...
    public function suppression(EtudiantRepository $etudiantRepository,$id): Response
    {
    ...
    public function edit(Request $request,EtudiantRepository $etudiantRepository,int $id): Response
    {
        $etudiant=$etudiantRepository->findOneBy(['id'=>$id]);
        $form=$this->createForm(EtudiantFormType::class, $etudiant);
        $form->handleRequest($request);
