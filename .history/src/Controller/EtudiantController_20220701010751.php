...
use App\Controller\EtuFormType;
...
class EtudiantController extends AbstractController
{
    ...
    public function suppression(Etudiant $etudiant,EtudiantRepository $etudiantRepository): Response
    {
    ...
    #[Route('/{nom}/search', name: 'search_etudiant')]
    public function search(Request $request,EtudiantRepository $doctrine,$nom): Response
    {
        $etudiant=new Etudiant();
        $form=$this->createForm(EtuFormType::class, $etudiant);
        $form->handleRequest($request);
        if($form->isSubmitted()&& $form->isValid()){
            $b=$doctrine->search($nom,true);
